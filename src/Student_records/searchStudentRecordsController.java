...
/**
 * Etsi opiskelijakohtaisia suorituksia FXMl tiedoston controller
 * @author Miska
 */

public class searchStudentRecordsController {
    ...
    /**
     * Etsii opiskelijakohtaisia suorituksia metodi - Etsii tietokannasta opiskelijakohtaisia suorituksia syötetyn opiskelija_id:n perusteella
     * @param event Etsi opiskelijakohtaisia suorituksia
     */

    public void searchRecordsBtn(ActionEvent event) {
        ...
        try {
            ...
            int studentID = Integer.parseInt(searchBar.getText());


            ResultSet rs = conn.createStatement().executeQuery("SELECT * FROM suoritukset WHERE opiskelija_id = '" + studentID + "'");
